...
export default function App() {
  ...
  const [lastMove, setLastMove] = useState<{ from; to } >(null);
  const [isMenuOpen, setIsMenuOpen] = useState(false);
  const [isHelpOpen, setIsHelpOpen] = useState(false);
  const [gameOverResult, setGameOverResult] = useState<string >(null);
  const [capturedPieces, setCapturedPieces] = useState<{ white, black }>({ white: [], black: [] });
  ...
  // --- Render Helpers ---
  const getSquareColor = (isLight, square) => {
    // Highlight last move
